...
bot_token = '1549307401:AAFk-6aNZNm6xBPD1CCON4TJ3YOOl-aFM8Q'
bot = telebot.AsyncTeleBot(bot_token)
admin_list = [1151436944]
...
while True:
	...
	for i in row:
		...
		if aa == 1:
			...
			bott = telebot.TeleBot(bot_token).send_message(1151436944,f'<b>Рассылка запущена</b>',parse_mode='HTML')
			for user in users:
				time.sleep(0.05)
				amm += 1
				print(user)
